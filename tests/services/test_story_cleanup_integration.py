...
class TestStoryCascadingCleanup:
    ...
    def sample_epic_with_stories(self, epic_service, sample_stories):
        ...
        epic = epic_service.create_epic(
            title="Test Epic",
            description="Test epic with stories",
    ...
    def test_delete_story_removes_from_sprint(self, story_service, sprint_service, sample_stories, sample_sprint_with_stories):
    ...
    def test_delete_story_removes_from_epic(self, story_service, epic_service, sample_stories, sample_epic_with_stories):
    ...
    def test_delete_story_removes_from_both_sprint_and_epic(
        self, story_service, sprint_service, epic_service, 
        sample_stories, sample_sprint_with_stories, sample_epic_with_stories
    ):
    ...
    def test_delete_story_preserves_other_artifacts(
        self, story_service, sprint_service, epic_service, sample_stories
    ):
    ...
    def test_data_consistency_after_multiple_deletions(
        self, story_service, sprint_service, epic_service, sample_stories,
        sample_sprint_with_stories, sample_epic_with_stories
    ):
