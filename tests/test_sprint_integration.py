...
class TestSprintIntegration:
    ...
    def test_manage_sprint_stories_tool(self, server):
        ...
        add_result = manage_tool.apply_ex(
            sprint_id=sprint_id,
            action="add",
            story_id=story_id
        )
        ...
        remove_result = manage_tool.apply_ex(
            sprint_id=sprint_id,
            action="remove",
            story_id=story_id
        )
    ...
    def test_sprint_workflow_integration(self, server):
        ...
        from src.agile_mcp.tools.sprint_tools import (
            CreateSprintTool, UpdateSprintTool, ManageSprintStoriesTool, 
            GetSprintProgressTool, GetActiveSprintTool
        )
        from src.agile_mcp.tools.story_tools import CreateStoryTool
