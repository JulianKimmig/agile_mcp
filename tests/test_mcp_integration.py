...
class TestMCPServerIntegration:
    ...
    def test_tool_iteration(self) -> None:
        ...
        assert len(tools) == 15  # We have 2 project tools + 1 documentation tool + 5 story tools + 7 sprint tools
        ...
        sprint_tools = ["create_sprint", "get_sprint", "list_sprints", "update_sprint", 
                       "manage_sprint_stories", "get_sprint_progress", "get_active_sprint"]
    ...
    def test_set_mcp_tools(self, mock_fastmcp) -> None:
        ...
        assert len(mock_mcp._tool_manager._tools) == 15
    ...
    def test_create_mcp_server_sse(self) -> None:
        ...
        with patch('agile_mcp.server.FastMCP') as mock_fastmcp:
            ...
            result = self.server.create_mcp_server(
                transport="sse", 
                host="localhost", 
                port=9000
            )
    ...
    def test_integration_with_real_tools(self) -> None:
        ...
        story = self.server.story_service.create_story(
            ...
            description="This story tests the integration"
        )
